						...
						<tbody>
							<tr>
								...
								<div class="form-group">
								  ...
								  <input class="form-control" rows="10" id="address"></input>
								</div>
								<div class="form-group">
								  <label for="postcode">우편번호</label>
								  <input class="form-control" rows="10" id="postcode"></input>
								</div>
								<div class="form-group">
								  <label for="jobstateid">구직상태</label>
								  <input class="form-control" rows="10" id="jobstateid"></input>
								</div>
								<div class="form-group">
								  <label for="jobgroupid">희망직종</label>
								  <input class="form-control" rows="10" id="jobgroupid"></input>
								</div>
								<div class="form-group">
								  <label for="rgbid">희망근무지(시/도)</label>
								  <input class="form-control" rows="10" id="rgbid"></input>
								</div>
								<div class="form-group">
								  <label for="employstatusid">희망근무형태</label>
								  <input class="form-control" rows="10" id="employstatusid"></input>
								</div>
								<div class="form-group">
								  <label for="salaryid">희망연봉</label>
								  <input class="form-control" rows="10" id="salaryid"></input>
								</div>
								
							    <div class="form-group">
								  <label for="coverletter">자기소개서</label>
								  <textarea class="form-control" rows="10" id="coverletter"></textarea>
								</div>
